...
export default function Projects({
  ...
  projects = [
    ...
    },
    {
      ...
      description: "A comprehensive showcase of brand identity, marketing materials, and merchandise design across multiple projects.",
      longDescription: "A curated collection of my graphic design work spanning multiple industries. This includes complete brand identity packages for local businesses like Meister Spud, tech-focused marketing materials for SaaS platforms like LessonPlanner, and successful mascot rebranding initiatives for university organizations.",
      techStack: ["Adobe Illustrator", "Photoshop", "Brand Identity", "Social Media Graphics"],
      achievements: [
        "Led GDSC NU Baliwag mascot rebranding & merchandise launch",
        "Designed complete brand identity for Meister Spud",
        "Developed social media campaigns for LessonPlanner",
      ],
      year: "2023 - 2024",
      link: "/projects/graphic-designing",
      linkLabel: "View Design Dossier",
    },
  ],
  className = "",
}: ProjectsProps) {
