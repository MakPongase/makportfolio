  ...
  works = [
    {
      ...
      description:
        "Restructured AWS Cloud Clubs – NU Baliwag into an independent student chapter, organizing technical workshops, Community Day North 2025, and national marketing initiatives across Philippine chapters.",
    ...
    },
    {
      ...
      title: "DIALYLINK",
      description:
        "A telemedicine and patient monitoring platform featuring AI-assisted triage that retrieves patient medical records directly from PostgreSQL to reduce hallucinations for Nephrologists and patients.",
    ...
    },
    {
      ...
      description:
        "A construction management system featuring supplier bidding, dynamic BOQ price calculation, AI-assisted progress report generation, and equipment location tracking.",
    ...
    },
    {
      ...
      title: "BIZWISE",
      description:
        "A dual-sided service marketplace and business management platform for MSMEs that syncs customer bookings to financial ledgers with cash flow forecasting and revenue trend analysis.",
    ...
    },
    {
      ...
      description:
        "A 3D virtual recreation of the NU Baliwag campus in Roblox Studio, built from real architectural photos and Google Maps data, reaching 3,000+ visitors in week one.",
    ...
    },
    {
      ...
      description:
        "A Philippine public high school virtual campus built in Roblox Studio, recreating open corridors, classrooms, and social hangout spots for student immersion.",
